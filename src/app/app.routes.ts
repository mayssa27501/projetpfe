...
import { AjouterBoxComponent } from './modules/admin/dashboards/ajouter-box/ajouter-box.component';
// Import the new component
import { AjouterGroupeOnduleurComponent } from './modules/admin/dashboards/ajouter-groupe-onduleur/ajouter-groupe-onduleur.component';
        ...
        children: [
            ...
            {path: 'dashboards', children: [
                ...
                {path: 'crypto', loadChildren: () => import('app/modules/admin/dashboards/crypto/crypto.routes')},
                {
                    path: 'ajouterbox',
                    loadChildren: () =>
                      import('app/modules/admin/dashboards/ajouter-box/ajouter-box.routes').then(m => m.AJOUTERBOX_ROUTES)
                },
                {
                    path: 'ajouteronduleur',
                    loadChildren: () =>
                      import('app/modules/admin/dashboards/ajouter-onduleur/ajouter-onduleur.routes').then(m => m.AJOUTERONDULEUR_ROUTES)
                },
                // Added route for AjouterGroupeOnduleurComponent
                {
                    path: 'ajoutergroupeonduleur',
                    loadChildren: () =>
